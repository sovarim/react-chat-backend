...
var ChatController = /** @class */ (function () {
    ...
    ChatController.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, existChat, chat, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        existChat = _a.sent();
                        if (existChat) {
                            return [2 /*return*/, res.status(201).json(existChat)];
                        }
                        return [4 /*yield*/, ChatModel_1.default.create({ users: [req.user.id, userId] })];
                    case 2:
                        chat = _a.sent();
                        return [4 /*yield*/, chat.populate('users', '-password')];
                    case 3:
                        chat = _a.sent();
                        return [2 /*return*/, res.status(201).json(chat)];
                    case 4:
                        error_1 = _a.sent();
    ...
    ChatController.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var params, chat, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
